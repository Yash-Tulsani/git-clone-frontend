                ...
                (
                    result ? (
                        <div className='mt-10 text-xl'>
                            ...
                            <Button onClick={resetForm} style={{color:"white"}} variant="contained" color='secondary'>Reset</Button>
                        </div>
                            ...
                            <form class="space-y-6" onSubmit={handleSubmit} >
                                ...
                                <div>
                                    <button type="submit" class="flex w-full justify-center shadow-xl rounded-md bg-[#F58F3C] px-3 py-1.5 text-lg font-semibold leading-6 text-white shadow-sm hover:bg-[rgb(207,112,35)] focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[rgb(255,170,101)]">Submit</button>
                                </div>
                            </form>
